...
Run 20260813_222749 against `https://yhwxmkywrja43z6km6tj2gpb4y0goosl.lambda-url.ap-southeast-1.on.aws`.
...
|-------|---------------------------|-------|
| **A — cold** | every episodic memory archived (29 → 23 active) | the sample |
| **B — warm** | the memory phase A itself built (23 active) | **the same** sample |
